...
public class StatementRecordValidFirstValidatorTest
{
  ...
  public void testValidateStatements() throws Exception
  {
    ...
    StatementRecordValidFirstValidator valVal = new StatementRecordValidFirstValidator();
    List<StatementErrorRecord> errors = valVal.validateStatements(records);
